...
<main id="content" class="alumni-landing-page">
  <section class="section ag-section">
    <div class="container">
      ...
      <h2 class="ag-subtitle">COMPTE RENDU DE L'ASSEMBLÉE GÉNÉRALE</h2>
      <p class="ag-rapporteur">
        Rapport (rédactrice) : Aurélie TRUCHASSOU – SYMA 01
      </p>
      <h3>Gouvernance :</h3>
      <ul>
      ...
      <ul>
        <li>Le site a été refondu en 2017...</li>
        <li>...</li>
      </ul>
      <h3>Interface (Animatrice : Claudine ROUX - RE INFO 74)</h3>
      <ul>
        <li>...</li>
      </ul>
      <!-- Continuez à structurer le reste du compte rendu comme sur la photo -->
    </div>
  </section>
</main>
